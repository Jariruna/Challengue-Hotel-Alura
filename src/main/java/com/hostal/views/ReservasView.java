...
//	}
	...
	public ReservasView() {
		...
		JLabel lblSiguente = new JLabel("    SIGUIENTE");
		lblSiguente.setForeground(new Color(255, 255, 255));
		lblSiguente.setFont(new Font("Dialog", Font.PLAIN, 16));
	...
	protected void guardarReserva() {
		...
		Date dateSalida=Date.valueOf(fechaEgreso);
		...
		Reserva reserva=new Reserva(dateIngreso,dateSalida,dvalor,forma);
