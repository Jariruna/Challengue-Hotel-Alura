...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long reservaId) {
		...
		lblTitulo.setBounds(576, 32, 280, 42);
		...
		separator_1_2_5.setBounds(558, 553, 289, 2);
	...
	protected void guardarHuesped() {
		...
		if(nombre.isBlank() || apellido.isBlank() || documento.isBlank() || fechaNacimiento.isBlank() || nacionalidad.isBlank() ||telefono.isBlank() || reservaId.isBlank() ) {
		...
		Huesped huesped = new Huesped(nombre, apellido, documento, Date.valueOf(fechaNacimiento), nacionalidad, telefono);
